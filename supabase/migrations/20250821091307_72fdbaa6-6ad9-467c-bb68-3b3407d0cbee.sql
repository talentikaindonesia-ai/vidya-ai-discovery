...
-- Create function for secure profile data access
...
CREATE POLICY "Users can view assessment results securely"
...
CREATE POLICY "Users can insert assessment results securely"
ON public.assessment_results
FOR INSERT
WITH CHECK (
  auth.uid() = user_id 
...
CREATE POLICY "Users can update assessment results securely"
ON public.assessment_results
FOR UPDATE
USING (
  auth.uid() = user_id 
...
CREATE POLICY "Users can view progress securely"
...
CREATE POLICY "Users can insert progress securely"
ON public.user_progress
FOR INSERT
WITH CHECK (
  auth.uid() = user_id 
...
CREATE POLICY "Users can update progress securely"
ON public.user_progress
FOR UPDATE
USING (
  auth.uid() = user_id 
